...
class User extends Common
{
    ...
    public function ticket()
    {
        ...
        $data = Db::name("order")->alias("o")->where("o.isshow",1)->where("userid", $uid)->where("isdel", 0)->join("cinema_platter p", "o.pid=p.id", "left")->join("cinema_movie m", "p.movieid=m.id")->join("cinema_moviehall h", "p.hallid=h.id")->join("cinema_user u", "u.id=o.userid")->field($field)->order("o.id desc")->select();
