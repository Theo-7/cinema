...
(function($,undefined){
	$.fn.zyUpload = function(options,param){
		...
		return this.each(function(){
			...
			var _Dir = "/admin/tool/php_img_upload/";
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
				    ...
				    html += '							<img class="upload_image" src="/admin/tool/php_img_upload/control/images/add_img.png" style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
