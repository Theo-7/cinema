(function( $ ){
    ...
    $(function() {
        ...
        if ( !WebUploader.Uploader.support('flash') && WebUploader.browser.ie ) {
            ...
            if (flashVersion) {
                (function(container) {
                    ...
                    var swf = '/admin/tool/webUpload/expressInstall.swf';
                    // insert flash object
        ...
        uploader = WebUploader.create({
            ...
            dnd: '#dndArea',
            paste: '#uploader',
            swf: '/admin/tool/webUpload/Uploader.swf',
            chunked: false,
            chunkSize: 512 * 1024,
            server: '/admin/img/show',
            method:'POST',
            // runtimeOrder: 'flash',
        ...
        uploader.on("uploadSuccess",function(file,res){
            $("#tab-3").append('<input type="hidden" name="pictures[]" value="'+res._raw+'" />');
        });
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('/admin/tool/webUpload/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
